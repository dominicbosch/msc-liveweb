...
In our conceptual model we envision a \textrm{\acrshort{ced}} engine that requires \textrm{\acrshort{ced}} in order to detect complex event patterns and assembles higher-order events.
