...
% The essence of REST is to focus on creating loosely coupled services on the Web so that they can be easily reused [7]
% C. Pautasso and E. Wilde, “Why is the Web Loosely Coupled? A Multi-Faceted Metric for Service Design,” in Proc. of the 18th International World Wide Web Conference (WWW’09), Madrid, Spain, 2009, pp. 911–920.
...
\subsection{Subscribing to Web Resources}
% FIXME TODO this needs to be fixed together with the whole chapter!
