...
\begin{itemize}
	\item object: An unordered collection of name/value pairs, which can be thought of as a hash map, dictionary or struct.
	\item array: An ordered list of values, which can be thought of as an array, vector or list.
\end{itemize}
