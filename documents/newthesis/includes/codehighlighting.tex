...
\lstdefinelanguage{CoffeeScript}{
  keywords={exports, needle, pushEvent, params, typeof, new, true, false, catch, return, null, catch, switch, of, if, in, while, do, else, case, break, throw, for},
  keywordstyle=\color{blue}\bfseries,
  ndkeywords={this, console, err, resp, body},
  ndkeywordstyle=\color{lightblue}\bfseries,
  identifierstyle=\color{black},
  sensitive=false,
  comment=[l]{//},
...
\lstdefinelanguage{OwnRule}{
  keywords={expression, event, condition, conditions, action, actions, operator, selector, word, special, string, selstring, argument, instr, <, ==, >, >=, <=},
  keywordstyle=\color{blue}\bfseries,
  ndkeywords={on, if, do},
  ndkeywordstyle=\color{lightblue}\bfseries,
  identifierstyle=\color{black},
