...
Data changes on an information system can be detected and imposed from the outside, if proper interfaces exist.
...
% \begin{figure}[!ht]
%   \centering
%   \includegraphics[width=0.8\textwidth]{figures/InformationSpace_Merge}
%   \caption{The Internet as Information Space}
%   \label{fig:InformationSpace_Merge}
% \end{figure}
