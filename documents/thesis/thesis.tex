...
stylus for css
(Section at the end about existing rule languages)
...
Such systems are merely event sinks which add no value to the Web, but for their users.
