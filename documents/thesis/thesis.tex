...
\subsection{Asynchronous Systems \& Closures}
% NOTES / TODOs:
%
% Variable bindings
...
Certain optimization approaches and techniques that regained importance through upcoming programming languages require special attention to avoid common pitfalls.
...
\begin{figure}[h!]
\centering
  \includegraphics{Closures_Synchronous}
...
\centering
%,angle=-90
  \makebox[\textwidth][c]{\includegraphics{Closures_Asynchronous}}%
...
\centering
%,angle=-90
  \makebox[\textwidth][c]{\includegraphics{Closures_Closure-1}}%
...
\centering
%,angle=-90
  \makebox[\textwidth][c]{\includegraphics{Closures_Closure-2}}%
\caption{Closure Scope}
%\end{center}
\end{figure*}
...
\centering
%,angle=-90
  \makebox[\textwidth][c]{\includegraphics{Closures_Closure-3}}%
\caption{Closure Scope}
%\end{center}
\end{figure*}
